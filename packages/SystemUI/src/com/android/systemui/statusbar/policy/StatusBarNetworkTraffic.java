    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.Secure
                    .getUriFor(Settings.Secure.NETWORK_TRAFFIC_ENABLED), false,
                    this, UserHandle.USER_CURRENT);
            resolver.registerContentObserver(Settings.Secure
                    .getUriFor(Settings.Secure.NETWORK_TRAFFIC_AUTOHIDE), false,
                    this, UserHandle.USER_CURRENT);
            resolver.registerContentObserver(Settings.Secure
                    .getUriFor(Settings.Secure.NETWORK_TRAFFIC_UNIT_TYPE), false,
                    this, UserHandle.USER_CURRENT);
        }
        ...
        public void onChange(boolean selfChange) {
                ...
                mEnabled = Settings.Secure.getIntForUser(resolver,
                ...
                mUnitType = Settings.Secure.getIntForUser(resolver,
                    Settings.Secure.NETWORK_TRAFFIC_UNIT_TYPE, 0, UserHandle.USER_CURRENT);
